...
public class StabbedSherlockPreferenceActivityTest {
    private ActivityController<TestStabbedSherlockPreferenceActivity> mActivityController;
    private TestStabbedSherlockPreferenceActivity mActivity;

    @Before
    public void setUp() throws Exception {
        mActivityController = Robolectric.buildActivity(TestStabbedSherlockPreferenceActivity.class);
