...
public class StabbedActionBarActivityTest {
    private ActivityController<TestStabbedActionBarActivity> mActivityController;
    private TestStabbedActionBarActivity mActivity;

    @Before
    public void setUp() throws Exception {
        mActivityController = Robolectric.buildActivity(TestStabbedActionBarActivity.class);
