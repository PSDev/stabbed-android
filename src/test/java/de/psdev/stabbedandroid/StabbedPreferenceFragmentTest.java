...
@Ignore("Not yet implemented in Robolectric 2.2")
public class StabbedPreferenceFragmentTest {
    private ActivityController<TestStabbedActivity> mActivityController;
    private TestStabbedActivity mActivity;
    private TestStabbedPreferenceFragment mTestStabbedFragment;

    @Before
    public void setUp() throws Exception {
        mActivityController = Robolectric.buildActivity(TestStabbedActivity.class);
        mActivity = mActivityController.get();
        mTestStabbedFragment = new TestStabbedPreferenceFragment();
    }
