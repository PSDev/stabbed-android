...
public class StabbedSupportListFragmentTest {
    ...
    private TestStabbedSupportListFragment mTestStabbedFragment;

    @Before
    public void setUp() throws Exception {
        mActivityController = Robolectric.buildActivity(TestStabbedSupportFragmentActivity.class);
        mActivity = mActivityController.get();
        mTestStabbedFragment = new TestStabbedSupportListFragment();
    }
